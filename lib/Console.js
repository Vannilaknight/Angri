...
exports.info = function (message) {
    console.log(Color.gray(timestamp) + Color.cyan(message));
};

exports.warning = function (message) {
    console.log(Color.gray(timestamp) + Color.yellow("[WARNING] ") + message);
};
...
exports.requestView = function (req) {
    console.log(Color.gray(timestamp) + Color.blue("[REQUEST VIEW]: ") + JSON.stringify(req))
}
